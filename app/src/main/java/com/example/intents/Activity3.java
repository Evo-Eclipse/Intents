...
public class Activity3 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Button button21 = findViewById(R.id.But31);
        button21.setOnClickListener(view -> navigateToActivity("Activity1"));

        Button button22 = findViewById(R.id.But32);
        button22.setOnClickListener(view -> navigateToActivity("Activity2"));

        Button button23 = findViewById(R.id.But33);
    ...
    private void navigateToActivity(String targetActivity) {
        ...
        Intent intent = new Intent(Activity3.this, activityClass);
    ...
    private void showPathAndFinish() {
        ...
        Toast.makeText(Activity3.this, path.toString(), Toast.LENGTH_SHORT).show();
        pathfinder.clear();
        finish();
    }
}
